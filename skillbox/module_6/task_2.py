...
print(name, ', ваша задолженость составляет', duty, 'рублей')
redemption = int(input('Сколько рублей вы внесете прямо сейчас, чтобы её погасить?  '))
while duty >= redemption:
    print('Маловато,', name, 'Давайте еще раз.')
    duty = int(input('Сколько рублей вы внесете прямо сейчас, чтобы её погасить?  '))
